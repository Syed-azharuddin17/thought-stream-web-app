...
// .wrangler/tmp/bundle-5M2RaF/checked-fetch.js
...
// node_modules/@azharuddinsyed/medium-commons/dist/index.js
var require_dist = __commonJS({
  "node_modules/@azharuddinsyed/medium-commons/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.updateBlogValidation = exports.createBlogValidation = exports.signInValidation = exports.signUpValidation = void 0;
    var zod_1 = __importStar(require_lib());
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Azhar\\OneDrive\\Desktop\\Co-op\\projects\\medium\\backend\\Medium\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\Azhar\\OneDrive\\Desktop\\Co-op\\projects\\medium\\backend\\Medium\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
      ...
      "inlineSchemaHash": "4b3433852c97d7e71ebf55f925142df62993d240efa6d88d58b4084e19f03c01",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-5M2RaF/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-5M2RaF/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
init_checked_fetch();
init_modules_watch_stub();
var import_medium_commons = __toESM(require_dist());
...
userRoutes.post("/signup", async (c) => {
  ...
  const { success } = import_medium_commons.signUpValidation.safeParse(body);
  if (!success) {
    return c.json({
...
userRoutes.post("/signin", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_commons.signInValidation.safeParse(body);
  if (!success) {
    return c.json({
      msg: "validation failed!"
    });
  ...
  try {
    const signInusers = await prisma.user.findFirst({
      where: {
        username: body.username,
        password: body.password
      }
    });
    const name = signInusers?.name;
    if (!signInusers) {
...
init_checked_fetch();
init_modules_watch_stub();
var import_medium_commons2 = __toESM(require_dist());
var import_edge2 = __toESM(require_edge3());
var blogRoutes = new Hono2();
blogRoutes.use("/*", async (c, next) => {
  const token = c.req.header("authorization") || " ";
  const decodeToken = await verify2(token, c.env.JWT_SECRET);
  if (decodeToken) {
...
blogRoutes.post("/", async (c) => {
  ...
  const { success } = import_medium_commons2.createBlogValidation.safeParse(body);
  if (!success) {
    return c.json({
      msg: "Validation failed!"
    });
...
blogRoutes.put("/", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_commons2.updateBlogValidation.safeParse(body);
  if (!success) {
    return c.json({
      msg: "Validation failed!"
    });
