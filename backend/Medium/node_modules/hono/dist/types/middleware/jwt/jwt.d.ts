...
export declare const verify: (token: string, publicKey: SignatureKey, alg?: SignatureAlgorithm) => Promise<import("hono/utils/jwt/types").JWTPayload>;
export declare const decode: (token: string) => {
    header: import("hono/utils/jwt/jwt").TokenHeader;
    payload: import("hono/utils/jwt/types").JWTPayload;
};
export declare const sign: (payload: import("hono/utils/jwt/types").JWTPayload, privateKey: SignatureKey, alg?: SignatureAlgorithm) => Promise<string>;
