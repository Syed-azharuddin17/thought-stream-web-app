...
declare const _default: {
    ...
    Fragment: ({ children, }: {
        key?: string;
        children?: import("./base").Child | import("hono/utils/html").HtmlEscapedString;
    }) => import("hono/utils/html").HtmlEscapedString;
    StrictMode: ({ children, }: {
        key?: string;
        children?: import("./base").Child | import("hono/utils/html").HtmlEscapedString;
    }) => import("hono/utils/html").HtmlEscapedString;
    isValidElement: (element: unknown) => element is import("./base").JSXNode;
    createElement: (tag: string | Function, props: import("./base").Props | null, ...children: (string | number | import("hono/utils/html").HtmlEscapedString)[]) => import("./base").JSXNode;
